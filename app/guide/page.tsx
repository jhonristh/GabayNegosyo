...
function GuideContent() {
  ...
  return <main className="screen client-guide">
    ...
    <div className="guide-note"><strong>How to use this guide</strong><p>Choose a stage below, open an item, and follow its official agency link. Free accounts see the overview; Premium accounts also see preparation lists and steps.</p></div><div className="guide-note"><strong>About dates and penalties</strong><p>Local due dates, monthly remittances, and event-based filings need individual confirmation. This guide does not turn an approximate date into a filing deadline. Check the issuing agency before filing or paying.</p></div>
