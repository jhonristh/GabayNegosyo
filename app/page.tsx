...
export default function LandingPage() {
  return <main className="screen landing v05-landing">
    ...
    <section id="credits" className="v07-credits v05-section"><p className="v05-kicker">ABOUT THE PROJECT</p><h2>Built to make compliance easier to understand.</h2><p>GabayNegosyo is a feasibility study prototype. Its research and business concept inform the product; the website presents that concept as an interactive guide. Contributor names and individual roles have not yet been confirmed in the project materials, so this release does not assign credit to specific people.</p><p>It is independent of government agencies. Verify current forms, dates, and rules with their official sources before filing.</p><div><Link href="/disclaimer">Read the disclaimer ↗</Link><Link href="/privacy">Privacy &amp; data ↗</Link></div></section>
