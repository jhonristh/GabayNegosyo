...
export const PENALTY_DISCLAIMER =
  "This is an estimate for informational purposes only. Actual penalties and government assessments may differ. Users should verify applicable rates and requirements through official government sources.";
